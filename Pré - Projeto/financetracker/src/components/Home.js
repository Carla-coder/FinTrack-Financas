...
import { faHome, faDollarSign, faFileAlt, faBell, faChartBar } from '@fortawesome/free-solid-svg-icons';
...
const Home = ({ currentUser, expenses, handleAddExpense }) => {
  ...
  return (
    <Container>
      ...
      {activePage === 'expenses' && <ExpensesPage onAddExpense={handleAddExpense} />}
      {activePage === 'records' && <ExpensesList expenses={expenses} />}
      {activePage === 'reports' && <ReportsPage expenses={expenses} />}
