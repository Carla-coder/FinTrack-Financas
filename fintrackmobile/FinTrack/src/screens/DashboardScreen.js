...
//       name: category,
//       amount: categoryTotals[category],
//       color: `#${Math.floor(Math.random() * 16777215).toString(16).padStart(6, '0')}`, // gera uma cor aleatória com 6 caracteres
//       legendFontColor: "#7F7F7F",
//       legendFontSize: 15,
//     }));
//   };
...
//             <Text style={styles.menuItem}>Transações</Text>
//           </TouchableOpacity>
//           <TouchableOpacity onPress={() => navigation.navigate("Orçamentos")}>
//             <Text style={styles.menuItem}>Orçamentos</Text>
//           </TouchableOpacity>
...
//           <LineChart
//             data={prepareLineChartData()}
//             width={width - 40} // Ajusta a largura do gráfico
//             height={220}
//             chartConfig={{
//               backgroundColor: "#fff",
//               backgroundGradientFrom: "#f4f4f4",
...
//   },
//   chartWrapper: {
//     paddingHorizontal: 15, // Adiciona padding para gráficos
//   },
//   transactionsContainer: {
//     backgroundColor: "#fff",
//     padding: 10,
